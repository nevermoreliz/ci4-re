                    ...
                    <div class="card-body pt-3">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="dayNone" role="tabpanel">
                                ...
                                <div class="text-center">
                                    <img src="<?= base_url(); ?>dashboard/img/illustration/icon-appointment.webp" class="theme-filter" alt="launch" />
                    ...
                    <div class="card-body mb-n3 border-last-none">
                            ...
                            <div class="row g-0 sh-6">
                                <div class="col-auto">
                                    <a href="Doctors.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/profile/profile-14.webp" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <div class="mb-3 pb-3 border-bottom border-separator-light">
                            <div class="row g-0 sh-6">
                                <div class="col-auto">
                                    <a href="Doctors.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/profile/profile-12.webp" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                        ...
                        <div class="mb-3 pb-3 border-bottom border-separator-light">
                            <div class="row g-0 sh-6">
                                <div class="col-auto">
                                    <a href="Doctors.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/profile/profile-13.webp" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                        ...
                        <div class="mb-3 pb-3 border-bottom border-separator-light">
                            <div class="row g-0 sh-6">
                                <div class="col-auto">
                                    <a href="Doctors.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/profile/profile-15.webp" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                        ...
                        <div class="mb-3 border-bottom border-separator-light">
                            <div class="row g-0 sh-6">
                                <div class="col-auto">
                                    <a href="Doctors.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/profile/profile-16.webp" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
...
<div class="row">
    ...
    <div class="col-xl-6 mb-5">
        ...
        <div class="card w-100 sh-100 h-xl-100-card hover-img-scale-up position-relative">
            <img src="<?= base_url(); ?>dashboard/img/banner/cta-doctor.webp" class="card-img h-100 scale position-absolute" alt="card image" />
